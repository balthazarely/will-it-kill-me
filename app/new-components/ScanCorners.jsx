// ScanCorners.jsx
// Renders the four corner bracket decorations on the camera viewfinder.

export default function ScanCorners({ color = 'rgba(255,255,255,0.7)', size = 24, thickness = 2.5 }) {
  const s = thickness;
  const cornerStyle = { position: 'absolute', width: size, height: size };

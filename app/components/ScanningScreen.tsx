      ...
      <div className="flex flex-col gap-2 w-full max-w-[260px]">
        {STEPS.map((step, i) => (
          ...
          >
            <div className="w-[18px] h-[18px] rounded-full shrink-0 bg-violet-400/15 border border-violet-400/30 flex items-center justify-center">
              {i < 2 ? (
                ...
                <svg width="9" height="7" viewBox="0 0 9 7">
                  <path d="M1 3.5L3.5 6 8 1" stroke="#a78bfa" strokeWidth="1.6" fill="none" strokeLinecap="round" strokeLinejoin="round" />
                </svg>
              ) : (
                /* spinner */
            ...
            <span className={`text-[12px] font-medium ${i < 2 ? 'text-white/50' : 'text-white/35'}`}>
              {step}
            </span>
          </div>
        ))}
